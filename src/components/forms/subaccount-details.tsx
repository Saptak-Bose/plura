...
const FormSchema = z.object({
  name: z
    .string()
    .min(2, { message: "Account Name must be of atleast 2 characters." }),
  companyEmail: z
    .string()
    .min(1, { message: "Account Email must be of atleast 1 character." }),
  companyPhone: z.string().min(1, {
    message: "Account Phone Number must be of atleast 1 character.",
  }),
