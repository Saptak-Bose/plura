...
const UserDataSchema = z.object({
  name: z.string().min(1, { message: "Name must be of atleast 1 character." }),
  ...
  useEffect(() => {
    if (data.user) {
      const fetchDetails = async () => {
        const response = await getAuthUsetDetails();
    ...
    if (type === "agency") {
      ...
      if (response) {
        ...
        toast({
          variant: "destructive",
          title: "Failed",
          description: "Could not update the permissions.",
        });
      }
            ...
            {authUserData?.role === "AGENCY_OWNER" ? (
              <div>
                ...
                <FormDescription className="mb-4">
                  ...
                  access control for each Sub Accounts. This is only visible to
                  the Agency Owners.
                </FormDescription>
